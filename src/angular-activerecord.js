angular.module('ActiveRecord', ['ng']).provider('ActiveRecord', function() {
	'use strict';
	...
	this.setResponseExtractor = function (fn) {
		responseExtractor = fn;
	};

	this.setRequestInterceptor = function (fn) {
		...
		ActiveRecord.prototype = {
			...
			$parse: function (data, options) {
				if (responseExtractor) {
					return responseExtractor(data, options);
				}
				return data;
			},
